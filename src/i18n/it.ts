...
const it: Dictionary = {
  ...
  home: {
    ...
    stats: ['International Community', 'Studenti internazionali', 'Volontariato e comunità', 'Santiago de Compostela'],
    about: {
      number: '01 / CHI SIAMO',
